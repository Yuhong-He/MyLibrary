...
?>
	<body>
		...
		<div class="article">
			...
			<p style="text-align:left;text-indent:2em;">学者著书不易，我不会在网站直接放置下载链接。但知识无价，学术自由，合理的文献互助请求我会支持。如果你编写维基百科，或者学习、研究云南地方文化历史而需要我所收集的资料，请通过<a href="https://zh.wikipedia.org/wiki/User_talk:瑞丽江的河水">我的维基百科讨论页</a>与我联系，也可以使用本站的“互助”提交请求。我不收取任何费用，希望云南这片土地能被更多人了解。</p>
