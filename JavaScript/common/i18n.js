let arrLang = {
    "en": {
        ...
        "OVERVIEW": "Overview",
        "INTRODUCTION1": "I come from Yunnan, China. Study Computer Science at Technological University Dublin since 2019. This website was developed based on the final project of the Web Development course in the upper semester of 2nd year. The site was built with a separate frontend and backend structure, the frontend using Bootstrap and jQuery, and the backend using PHP.",
        "INTRODUCTION2": "This website is only the learning project, the data is only for the demo.",
        "LIBRARY": "Library",
        "INTRODUCTION3": "I am an enthusiast of Yunnan history and geography, and I have a hobby that collects related books.",
        "INTRODUCTION4": "This site contains 2 databases:",
        "INTRODUCTION5-1": "",
        "INTRODUCTION5-2": " and ",
        "INTRODUCTION5-3": " under the \"Find Books\" menu, can search the e-book I already have. Now there are ",
        "INTRODUCTION5-4": " 2221 books info stored in the database.",
        "INTRODUCTION6-1": "",
        "INTRODUCTION6-2": " under the \"Find Books\" menu, can search for books from the 5.12 million DUXIU database. This data was coming from the internet.",
        "INTRODUCTION7": "If you need my collections during the study, you can ask for a request through the embedded \"Request\" entry (login required). After all, this site is just a learning project. Please use this site and any resources provided by me at your own risk and legal responsibility.",
        "FIREFOX_ISSUE": "Due to the restriction of the HTML & JavaScript loading mechanism of the Firefox browser, an error will occur when using Firefox to visit this site. Please use Chrome or Edge.",
        "SAFARI_ISSUE": "Some little bugs occur on the \"Find Book by Search\" page when using Safari to visit this site. The reason is not determined yet, probably relevant to the cookie mechanism.",
        "HELP_ME": "If you have any solution, please let me know. Many thanks.",
        ...
        "CLEAR": "Clear",
        "SS_ID": "SS ID",
        "PLEASE_SEARCH": "Please search something...",
    ...
    "hans": {
        ...
        "LIBRARY": "图书馆",
        "INTRODUCTION3": "我是一名云南史地爱好者，有收集云南书籍资料的兴趣。",
        "INTRODUCTION4": "本站包括两个数据库：",
        "INTRODUCTION5-1": "\"找书\"菜单下的",
        "INTRODUCTION5-2": "、",
        "INTRODUCTION5-3": "可查找我所拥有的书籍数据库，目前共录有",
        "INTRODUCTION5-4": "本书；",
        "INTRODUCTION6-1": "\"找书\"菜单下的",
        "INTRODUCTION6-2": "可查找读秀512万电子书数据库，读秀数据来自网络。",
        "INTRODUCTION7": "如您学习、研究需要我所收集的资料，可以通过本站的“互助”提交请求（需要登录）。最后，这个网站只是一个作业项目，请自行承担使用本站及任何本人所提供资料的风险与法律责任。",
        "FIREFOX_ISSUE": "由于Firefox浏览器对HTML页面中JavaScript的加载机制限制，使用Firefox访问本站会出现bug，请使用Chrome或Edge浏览器访问。",
        "SAFARI_ISSUE": "使用Safari浏览器访问本站的\"按书名找书\"页面会出现小bug，成因尚不明确，可能与Safari浏览器的cookie加载机制有关。",
        "HELP_ME": "如果您有解決方案，劳请告知我，万分感激！",
    ...
    "hant": {
        ...
        "LIBRARY": "圖書館",
        "INTRODUCTION3": "我是一名雲南史地愛好者，有收集雲南書籍資料的興趣。",
        "INTRODUCTION4": "本站包括兩個數據庫：",
        "INTRODUCTION5-1": "\"找書\"菜單下的",
        "INTRODUCTION5-2": "、",
        "INTRODUCTION5-3": "可查找我所擁有的書籍數據庫，目前共錄有",
        "INTRODUCTION5-4": "本書；",
        "INTRODUCTION6-1": "\"找書\"菜單下的",
        "INTRODUCTION6-2": "可查找讀秀512萬電子書數據庫，讀秀數據來自網絡。",
        "INTRODUCTION7": "如您學習、研究需要我所收集的資料，可以通過本站的「互助」提交請求（需要登錄）。最後，這個網站只是一個作業項目，請自行承擔使用本站及任何本人所提供資料的風險與法律責任。",
        "FIREFOX_ISSUE": "由於Firefox瀏覽器對HTML頁面中JavaScript的加載機製限制，使用Firefox訪問本站會出現bug，請使用Chrome或Edge瀏覽器訪問。",
        "SAFARI_ISSUE": "使用Safari瀏覽器訪問本站的\"按書名找書\"頁面會出現小bug，成因尚不明確，可能與Safari瀏覽器的cookie加載機製有關。",
        "HELP_ME": "如果您有解決方案，勞請告知我，萬分感激！",
