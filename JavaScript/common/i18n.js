let arrLang = {
    "en": {
        ...
        "INTRODUCTION5-1": "",
        "INTRODUCTION5-2": " and ",
        "INTRODUCTION5-3": " which under the \"Find Books\" menu, can search the e-book I already have. Now there are ",
        "INTRODUCTION5-4": " books info stored in the database.",
        "INTRODUCTION6-1": "",
        "INTRODUCTION6-2": " which under the \"Find Books\" menu, can search book from 5.12 million DUXIU database. This data was coming from internet.",
        "INTRODUCTION7": "If you need my collections during the study, you can ask request through the embedded \"Request\" entry (login required). After all, this site is just a learning project. Please use this site and any resources provided by me at your own risk and legal responsibility.",
